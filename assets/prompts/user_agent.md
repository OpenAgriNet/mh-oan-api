...
11. **When done, end abruptly.** When your goal is fulfilled or the assistant has answered your question, use the `EndConversation` tool to end the conversation. Do NOT include the word "EndConversation" in your text message — instead, call the tool directly without any text output.